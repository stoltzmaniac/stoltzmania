...
class SurfaceWaterStation(models.Model):
    ...
    div = models.BigIntegerField(null=True)
    wd = models.BigIntegerField(null=True)
    ...
    usgs_station_id = models.BigIntegerField(null=True)
    data_source = models.CharField(max_length=50, null=True)
    status = models.CharField(max_length=50, null=True)
    por_start = models.BigIntegerField(null=True)
    por_end = models.BigIntegerField(null=True)
    utm_x = models.FloatField(null=True)
    utm_y = models.FloatField(null=True)
